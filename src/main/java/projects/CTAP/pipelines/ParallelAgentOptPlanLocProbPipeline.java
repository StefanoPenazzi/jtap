...
public class ParallelAgentOptPlanLocProbPipeline implements Callable<Integer> {
	...
	private static final Logger log = LogManager.getLogger(ParallelAgentOptPlanLocProbPipeline.class);

	public static void main(String[] args) {
		System.exit(new CommandLine(new ParallelAgentOptPlanLocProbPipeline()).execute(args));
	}
