...
public class AttractivenessPipeline_v1 implements Callable<Integer> {
	...
	private static final Logger log = LogManager.getLogger(AttractivenessPipeline_v1.class);

	public static void main(String[] args) {
		System.exit(new CommandLine(new AttractivenessPipeline_v1()).execute(args));
	}
