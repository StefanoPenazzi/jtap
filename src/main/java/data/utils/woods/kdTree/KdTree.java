package data.utils.woods.kdTree;
...
public class KdTree {
    ...
    public static class Node {
        ...
        public Node(double[] coords, Object value) {
            coords_ = coords;
            this.value = value;
        }
        public Node(double x, double y,Object value) {
            this(new double[]{x, y}, value);
            this.value = value;
        }
        public Node(double x, double y, double z, Object value) {
            this(new double[]{x, y, z}, value);
            this.value = value;
        }
